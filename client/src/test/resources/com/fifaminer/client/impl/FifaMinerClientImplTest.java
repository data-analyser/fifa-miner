...
public class FifaMinerClientImplTest {
    ...
    public void testCalls() {
        ...
        fifaMinerClient.findPlayersByTransactionsAnalyse(
                1477574603286L, 1479064949173L, OrderingTypeTO.MAX_SELLS, "some-group", 5
        );
        fifaMinerClient.findPlayersByTransactionsAnalyse(Duration.TODAY, OrderingTypeTO.MAX_SELLS, "some-group", 5);
