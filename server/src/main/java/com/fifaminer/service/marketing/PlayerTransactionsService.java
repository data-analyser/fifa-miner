...
public interface PlayerTransactionsService {
    ...
    List<Long> findPlayers(Long startTime, Long endTime, OrderingType orderingType, Integer limit);

    List<Long> findPlayers(Duration duration, OrderingType orderingType, Integer limit);
}
